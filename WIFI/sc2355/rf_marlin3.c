...
#if defined(CONFIG_QCOM_BOARD) || defined(CONFIG_ASR_BOARD)
#define SYSTEM_WIFI_CONFIG_FILE "/lib/firmware/wifi_board_config.ini"
#define SYSTEM_WIFI_AB_CONFIG_FILE "/lib/firmware/wifi_board_config_ab.ini"
#define SYSTEM_WIFI_AC_CONFIG_FILE "/lib/firmware/wifi_board_config_ac.ini"
/*marlin3 lite AA ini file*/
#define SYSTEM_WIFI_AA_CONFIG_FILE "/lib/firmware/wifi_board_config_aa.ini"
#else
 ...
 * 2nd source: Xpeedic
 */
#define SYSTEM_WIFI_IPD_XPEEDIC_CONFIG_FILE "/vendor/etc/wcn/wifi_board_config.ini"
...
#define MARLIN_AD_CHIPID 0x23550003
	...
	if ((marlin_get_wcn_xpe_efuse_data() == WCN_XPE_EFUSE_DATA)) {
		...
		return wifi_nvm_parse(SYSTEM_WIFI_IPD_XPEEDIC_CONFIG_FILE, (void *)p);
	}
